...
#Özelliklerin modele etki-önem grafiği
...
#hiperparmetrelerin modele etkisinin nasıl bi noktada olduğunu nlmmızı sağlyan dinmik fonks.
...
val_curve_params(rf_final,X,y,"min_samples_split",range(1, 10),scoring="roc_auc")
